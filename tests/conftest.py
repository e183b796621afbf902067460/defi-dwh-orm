...
from tests.l_addresses_abis_tokens_protocols_labels_chains.fixtures import FIXTURES as POSITIONS_FIXTURES
...
@pytest.fixture(scope='session', autouse=True)
def l_addresses_abis_tokens_protocols_labels_chains(session):

    for contract, fixture in POSITIONS_FIXTURES.items():

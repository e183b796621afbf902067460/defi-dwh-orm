...
class PITDEXPoolAllocationOverview(Base):

    __tablename__ = 'pit_dex_pool_allocation_overview'
    __table_args__ = {
        'comment': 'DEX Pool Allocation Overview'
    }

    pit_dex_pool_allocation_overview_id = Column(Integer, primary_key=True)  # PK
    ...
    pit_dex_pool_allocation_overview_load_ts = Column(DateTime, server_default=func.now(), nullable=False)

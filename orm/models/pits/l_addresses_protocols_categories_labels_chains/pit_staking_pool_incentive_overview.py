...
class PITStakingPoolIncentiveOverview(Base):

    __tablename__ = 'pit_staking_pool_incentive_overview'
    __table_args__ = {
        'comment': 'Staking Pool Incentive Overview'
    }

    pit_staking_pool_incentive_overview_id = Column(Integer, primary_key=True)  # PK
    ...
    pit_staking_pool_incentive_overview_load_ts = Column(DateTime, server_default=func.now(), nullable=False)

...
class PITFarmingPoolOverview(Base):

    __tablename__ = 'pit_farming_pool_overview'
    __table_args__ = {
        'comment': 'Farming Pool Overview'
    }

    pit_farming_pool_overview_id = Column(Integer, primary_key=True)  # PK
    ...
    pit_farming_pool_overview_load_ts = Column(DateTime, server_default=func.now(), nullable=False)
